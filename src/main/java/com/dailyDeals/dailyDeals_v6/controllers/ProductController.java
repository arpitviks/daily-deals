...
public class ProductController implements ProductControllerInterface {
    ...
    @PostMapping("/")
    @Override
    public ResponseEntity<Object> addProduct(@Valid @RequestBody ProductEntity product, BindingResult result) throws CustomGlobalException {
        if (result.hasErrors()) {
        ...
        ProductEntity product1 = productService.addProduct(product,userName);
    ...
    @PatchMapping("/")
    @Override
    public ResponseEntity<Object> updateProduct(@RequestBody ProductEntity productToUpdate) throws CustomGlobalException, IllegalAccessException {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String userName = authentication.getName();
        ProductEntity updatedProduct = productService.updateProduct(productToUpdate, userName);
